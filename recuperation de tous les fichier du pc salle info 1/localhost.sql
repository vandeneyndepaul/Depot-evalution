...
--
-- Hôte : localhost:3306
-- Généré le : mar. 24 mai 2022 à 15:34
...
--
CREATE DATABASE IF NOT EXISTS `clicom` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `clicom`;
...
CREATE TABLE `produit` (
  ...
  `pro_decription` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `client`
  MODIFY `cli_num` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `commande`
--
ALTER TABLE `commande`
  MODIFY `com_num` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `produit`
--
ALTER TABLE `produit`
  MODIFY `pro_num` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Base de données : `EmpDep`
--
CREATE DATABASE IF NOT EXISTS `EmpDep` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `EmpDep`;
...
CREATE TABLE `Employes` (
  ...
  `emp_salaire` decimal(6,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `Employes` (`emp_id`, `emp_matricule`, `emp_nom`, `emp_prenom`, `emp_dep`, `emp_salaire`) VALUES
(1, 140, 'TIFIET', 'Tarek', '30', '2520.00'),
(2, 152, 'CONDA', 'Anna', '41', '3780.00'),
(14, 666, 'FER', 'Lucie', '42', '2556.00'),
(15, 42, 'MATIK', 'Otto', '44', '4130.00');
...
--
CREATE DATABASE IF NOT EXISTS `employes` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `employes`;
...
INSERT INTO `DEPART` (`NODEPT`, `NOMDEPT`, `noregion`) VALUES
('10', 'finance', '1'),
('20', 'atelier', '2'),
('30', 'atelier', '3'),
('31', 'vente', '1'),
...
INSERT INTO `EMPLOYES` (`NOEMP`, `NOM`, `PRENOM`, `dateemb`, `nosup`, `titre`, `WDEPT`, `SALAIRE`, `tauxcom`) VALUES
...
(26, 'simone', 'yvon', '2001-03-21 00:00:00', '10', 'secrétaire', '43', '20000', NULL),
(27, 'ada', 'yvon', '2001-03-21 00:00:00', '10', 'secrétaire', '42', '15500', NULL);
...
CREATE TABLE `formations` (
  ...
  `form_duree_heures` int(11) NOT NULL,
...
--
-- Structure de la table `form_stagiaires`
--
...
CREATE TABLE `stagiaires` (
  ...
  `sta_adresse` varchar(50) DEFAULT NULL,
  `sta_tel` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `voiture` (`voit_id`, `voit_marque`, `voit_prix`) VALUES
(1, 'Audi', 29990),
(2, 'BMW', 8500),
(3, 'Ford', 15550);
...
--
-- Index pour la table `form_stagiaires`
--
ALTER TABLE `form_stagiaires`
...
--
ALTER TABLE `formations`
  MODIFY `form_code` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `voiture`
  MODIFY `voit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Contraintes pour la table `form_stagiaires`
--
ALTER TABLE `form_stagiaires`
  ADD CONSTRAINT `form_stagiaires_ibfk_1` FOREIGN KEY (`form_code`) REFERENCES `formations` (`form_code`),
  ADD CONSTRAINT `form_stagiaires_ibfk_2` FOREIGN KEY (`sta_id`) REFERENCES `stagiaires` (`sta_id`);
--
...
--
-- Structure de la table `hotel_table`
--
...
--
-- Déchargement des données de la table `hotel_table`
--

INSERT INTO `hotel_table` (`hot_id`, `hot_sta_id`, `hot_nom`, `hot_categorie`, `hot_adresse`, `hot_ville`) VALUES
...
--
-- Index pour la table `hotel_table`
--
...
--
-- AUTO_INCREMENT pour la table `hotel_table`
--
ALTER TABLE `hotel_table`
...
--
ALTER TABLE `chambre`
  ADD CONSTRAINT `chambre_ibfk_1` FOREIGN KEY (`cha_hot_id`) REFERENCES `hotel_table` (`hot_id`);

--
-- Contraintes pour la table `hotel_table`
--
ALTER TABLE `hotel_table`
  ADD CONSTRAINT `hotel_table_ibfk_1` FOREIGN KEY (`hot_sta_id`) REFERENCES `station` (`sta_id`);
...
CREATE TABLE `Hotel` (
  `capacite_hotal` int(11) NOT NULL,
...
--
CREATE DATABASE IF NOT EXISTS `MaBaseDeDonnee` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `MaBaseDeDonnee`;
--
...
--
CREATE DATABASE IF NOT EXISTS `papyrus` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `papyrus`;
...
('admin', '2022-05-24 13:34:35', '{\"lang\":\"fr\",\"Console\\/Mode\":\"collapse\"}');
