...
try {
    ...
    $requete = $db->prepare("UPDATE SAV SET Client_Id = :Client_Id, SAV_Nom = :SAV_Nom, SAV_Prenom = : SAV_Prenom, SAV_Adress1 = :SAV_Adress1, SAV_Adress2 = :SAV_Adress2, SAV_Code_Post = :SAV_Code_Post, SAV_ville = :SAV_ville, SAV_Probleme = :SAV_Probleme, Dt_Crea = :Dt_Crea, SAV_id = :SAV_id WHERE Client_id = :id;" );
...
// Gestion des erreurs
    ...
    die("Fin du script (Script_Modification_SAV.php)");
}
