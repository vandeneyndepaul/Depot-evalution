...
<?php 
    ...
    $artist_liste = $requete->fetch(PDO::FETCH_OBJ);
    $requete->closeCursor();
...
<div class="container"> 
    ...
    <div class="row" >
        <div class="col-12 ">
            <form action="Script_Creation_SAV.php" method="POST">
                ...
                <input type="text" class="form-control form-control-md"  name="SAV_Nom" required="required"><br>
                <label for="SAV_Prenom" class="form-label">SAV_Prenom</label><br>
                <input type="text" class="form-control form-control-md"  name="SAV_Prenom" required="required"><br>
                <label for="SAV_Adress1" class="form-label">SAV_Adress1</label><br>
                <input type="text" class="form-control form-control-md"  name="SAV_Adress1"required="required"><br>
                <label for="SAV_Adress2" class="form-label">SAV_Adress2</label><br>
                <input type="text" class="form-control form-control-md"  name="SAV_Adress2"required="required"><br>
                <label for="SAV_Code_Post" class="form-label">SAV_Code_Post</label><br>
                <input type="text" class="form-control form-control-md"  name="SAV_Code_Post"required="required"><br>
                <label for="SAV_ville" class="form-label">SAV_ville</label><br>
                <input type="text" class="form-control form-control-md"  name="SAV_ville"required="required"><br>
