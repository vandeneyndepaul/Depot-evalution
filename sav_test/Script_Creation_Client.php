...
// die;
    ...
    if ($Client_Id == Null || $Client_Nom == Null || $Client_Prenom == Null || $Client_Adress1 == Null || $Client_Adress2 == Null || $Client_Code_Post== Null) {
...
try {
    ...
    $requete = $db->prepare("INSERT INTO Client (Client_Id, Client_Nom, Client_Prenom, Client_Adress1, Client_Adress2, Client_Code_Post, Client_ville) VALUES (:Client_Id, :Client_Nom, :Client_Prenom, :Client_Adress1, :Client_Adress2, :Client_Code_Post, :Client_ville);");
